...
<div class="container home-page">
        ...
        <div class="row">
                ...
                <div class="col-sm-8">
                  <h2 class='text-center'> Most Liked Articles</h2>
                                                ...
                                                @if(count($posts)>0)
                                                        ...
                                                        <div class=' post-content'>
                                                           ...
                                                           <div style="margin:10px;border: 1px solid #a3b9e0;padding: 20px;border-radius: 19px;">
                                                                    <div class='pull-right'>viewed :<span style='color: #30a3dc;font-size: 20px;border-bottom: 2px solid red;'> {{$post->views}}  times</span></div>
